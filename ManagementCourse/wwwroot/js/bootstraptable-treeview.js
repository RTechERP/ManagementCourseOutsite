...
(function ($) {
            ...
            if (column.checkbox || column.radio) {
                ...
                value = typeof value === 'undefined' || value === null ?
                    ...
                    if (that.options.treeView && column.field == that.options.treeField) {
                        var indent = item.level == that.options.treeRootLevel ? '' : sprintf('<span style="margin-left:%spx;"></span>', (item.level - that.options.treeRootLevel) * 30);
    ...
    $.extend($.fn.bootstrapTable.defaults, {
        ...
        collapseIcon: "fas fa-chevron-right",//折叠样式
        expandIcon: "fas fa-chevron-down",//展开样式<i class=""></i>
        //leafIcon: "fas fa-info"//叶子节点样式<i class="fas fa-info"></i>
    });
